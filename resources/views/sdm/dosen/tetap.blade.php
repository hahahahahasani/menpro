    ...
    <main>
        ...
        <section>
            <div class="container mx-auto mt-28 text-center">
                <div class="title">
                    <h1 class="text-5xl font-extrabold text-slate-800">Data Dosen Tidak Tetap</h1>
                </div>
                        ...
                        <tbody class="divide-y divide-gray-200">
                            @foreach ($akademik as $row)
                                <tr class="odd:bg-white-bone">
                                    ...
                                    <td class="whitespace-nowrap px-4 py-2 font-medium text-gray-900">
                                        {{ $row['pendidikan_terakhir']['S1'] }}
                                    </td>
                                    <td class="whitespace-nowrap px-4 py-2 font-medium text-gray-900">
                                        {{ $row['pendidikan_terakhir']['S2'] }}
                                    </td>
                                    <td class="whitespace-nowrap px-4 py-2 font-medium text-gray-900">
                                        {{ $row['pendidikan_terakhir']['S3'] }}
                                    </td>
                                </tr>
                            @endforeach
                            <tr>
